...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  computed: {
	    ...
	    text: function text() {
	      if (typeof window !== 'undefined') return (0, _utils.translations)(this.lang);
	    },
